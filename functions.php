...
function _teutopress_setup() {
	 ...
	 * If you're building a theme based on Teutopress, use a find and replace
	 * to change '_teutopress' to the name of your theme in all the template files
	 */
...
function _teutopress_scripts() {
	...
	wp_enqueue_script( '_teutopress-scripts', get_template_directory_uri() . '/js/scripts.js', array(), '20120206', true );
